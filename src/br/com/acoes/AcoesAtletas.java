...
public class AcoesAtletas {
	...
	public static void maratonaA(int distancia, int pesoAtleta, String tipoDeTerreno) {
	...
	public static void calcularTempoEstimado(int distancia) { //1km a cada 5 min -> média, 12 km por hora 
	...
	public static void metaProximaSemana(double kmPercorridoHoje) {
